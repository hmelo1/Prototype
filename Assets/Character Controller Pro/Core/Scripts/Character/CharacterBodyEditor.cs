...
namespace Lightbug.CharacterControllerPro.Core
{
    ...
    public class CharacterBodyEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            CustomUtilities.DrawMonoBehaviourField((CharacterBody)target);
            ...
            if (monoBehaviour.transform.localScale != Vector3.one)
                EditorGUILayout.HelpBox("Transform local scale must be <1,1,1>!", MessageType.Warning);
        ...
        void Draw2D3D()
        {
            ...
            EditorGUILayout.HelpBox(
                is2D.boolValue ?
                    "This component will automatically assign a Rigidbody2D component and a CapsuleCollider2D component at runtime." :
                    "This component will automatically assign a Rigidbody component and a CapsuleCollider component at runtime.",
                MessageType.Info
            );
        }
