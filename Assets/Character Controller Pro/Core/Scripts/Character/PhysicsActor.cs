...
namespace Lightbug.CharacterControllerPro.Core
{
    ...
    public abstract class PhysicsActor : MonoBehaviour
    {
        ...
        PhysicsActorSync physicsActorSync;
        ...
        public void ResetIKWeights() => animatorLink?.ResetIKWeights();
        ...
        public void InterpolateBody()
        {
            ...
            if (wasInterpolatingActor)
            {
                ...
                transform.position = resetPositionFlag ? targetPosition : Vector3.Lerp(startingPosition, targetPosition, interpolationFactor);
                transform.rotation = resetRotationFlag ? targetRotation : Quaternion.Slerp(startingRotation, targetRotation, interpolationFactor);
            }
        ...
        {
            physicsActorSync = gameObject.GetOrAddComponent<PhysicsActorSync>();
